...
class TeamViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let firstTeamCard = CardWithRoundImage(circle: circle1, emoji: emoji1, cardName: teamName1, card: teamCard1)
        
        let secondTeamCard = CardWithRoundImage(circle: circle2, emoji: emoji2, cardName: teamName2, card: teamCard2)
